...
export function CtaSection() {
  return (
    <section className="px-4 py-20 sm:px-6">
      <FadeIn>
        <div className="mx-auto max-w-content overflow-hidden rounded-[2rem] border border-brand/20 bg-gradient-to-br from-brand/15 via-white/[0.03] to-transparent px-6 py-12 sm:px-10">
